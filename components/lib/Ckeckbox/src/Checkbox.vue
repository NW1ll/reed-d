<template>
    <label class="rd-checkbox" :class="classes" @click="handleChange" tabindex="0">
...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        // 是否禁用
        const disabled = computed(() => props.disabled || checkboxGroupProps?.disabled);
        ...
        const classes = computed(() => ({
            "is-checked": isGroup.value ? modelValue.value.indexOf(label.value) > -1 && !indeterminate.value : modelValue.value && !indeterminate.value,
